...
public class ZDT3<S extends DoubleSolution<S>> implements Problem<S>
{
    ...
    private final Function<S>[] OBJECTIVE_FUNCTIONS = new Function[]
    {
        ...
        new Function<S>() {
            public double calculate(S solution) {
                ...
                return g * (1 - Math.sqrt(x1 / g) - (x1 / g) * Math.sin(10.0 * Math.PI * x1));
            }
        }
    };
    ...
    public void evaluate(S solution)
    {
        for (int i = 0; i < getNumberOfVariables(); i ++)
        {
            ...
            solution.setGene(i, Double.max(ZDT3.VARIABLE_BOUNDS_LOW[i], Double.min(ZDT3.VARIABLE_BOUNDS_HIGH[i], x)));
        }
